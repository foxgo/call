...
public class ShardedSnowflakeIdGenerator {
    ...
    public ShardedSnowflakeIdGenerator(CallIdProperties idProperties, ShardProperties shardProperties) {
        this(idProperties, shardProperties, Clock.systemUTC());
    }

    ShardedSnowflakeIdGenerator(CallIdProperties idProperties, ShardProperties shardProperties, Clock clock) {
        ...
        this.tableCount = shardProperties.getTableCount();
        this.clock = clock;
    }
